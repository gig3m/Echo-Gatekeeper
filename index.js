/**
 *	Amazon Echo Gate Skill
 *  This skill can control a gate that responds to text messages
 *  in the form of open, latch, and close.
 *  Modified version of SMSAlexa found at below URL
 *  https://github.com/mihaigalos/SmsAlexa
 */

// Twilio Credentials 
var accountSid = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
var authToken = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
var fromNumber = '15558675309';

var toNumber = '15558675309'
...
function SendSMS(to, body, callback) {
    ...
    var req = https.request(options, function (res) {
        ...
        res.on('end', function () {
			...
			var cardTitle = "Sent";
			var speechOutput = "Ok, I sent the message to the gate via SMS.";
...
function onIntent(intentRequest, session, callback) {
    ...
    if("sendMessage" === intentName){
        console.log("received sendMessage intent.");
        console.log("slots: "+intentRequest.intent.slots);
        var action = intentRequest.intent.slots.Action.value;
        console.log("Sending sms to gate with message: "+action);
        
        SendSMS(toNumber,action,callback);
    } else {
...
function getWelcomeResponse(callback) {
    ...
    var speechOutput = "GateKeeper, please say open, latch, or close.";
